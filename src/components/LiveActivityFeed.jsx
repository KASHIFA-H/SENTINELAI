...
export default function LiveActivityFeed() {
  ...
  return (
    <div className="rounded-xl p-5" style={{ background: '#FFFFFF', border: '1px solid #D1BFA2', height: 280 }}>
      ...
      <div className="overflow-y-auto scrollbar-thin space-y-1 font-mono text-xs" style={{ height: 220 }}>
        {events.map((e, i) => {
          const c = rowStyle(e.event_type, e.threat_score)
          return (
            <div key={e.id ?? i}
              className="flex items-start gap-3 px-3 py-2 rounded-lg transition-all animate-slide-in"
              ...
              {e.threat_score > 0 && (
                <span className="ml-auto shrink-0 text-xs font-bold px-1.5 py-0.5 rounded"
